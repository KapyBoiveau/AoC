...
def getCombi(room):
    m = [2 ** i for i in range(7) if room[0] & (1 << i)][::-1]
    g = [-(2 ** i) for i in range(7) if room[1] & (1 << i)][::-1]
                ...
                if isValid(newRoom): 
                    ...
                    if elev+1 <= 4: # si on peut monter
                        ...
                        if isValid(nextFloor):
                            if nextFloor == (0b1111111,0b1111111) and elev+1 == 4: # finish
...
floors = (1, (0b1100011,0b1100011), (0b0001100,0b0011100), (0b0010000,0), (0,0)) # pas de parse osef
